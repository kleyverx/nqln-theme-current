class VariantSelects extends HTMLElement {
    ...
    updateVariantInput() {
        ...
        productForms.forEach((productForm) => {
            ...
            const currentVariantMWS = document.querySelector('#variantIdBundle');
            if (currentVariantMWS) {
                currentVariantMWS.setAttribute('value', input.value);
                currentVariantMWS.dispatchEvent(new Event('change', { bubbles: true }));
            }
        });
    }
