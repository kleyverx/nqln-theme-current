class CartItems extends HTMLElement {
    ...
    async handleToCheckoutPage(e) {
        ...
        // Gate de captcha antes del checkout (si está habilitado)
        try {
            ...
            if (enabled && siteKey && typeof window.openCheckoutCaptcha === 'function') {
                window.openCheckoutCaptcha(checkoutHref);
                return;
            }
        } catch(_) {}
