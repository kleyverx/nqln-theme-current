	    ...
	    initSlideshow: function () {
            ...
            if (slickSlideshow.length) {
                slickSlideshow.each(function () {
                    ...
                    // Cargar YouTube API solo cuando sea necesario y visible
                    ...
                    // bind hover handlers once to avoid duplicates
                    self.off('mouseenter.overHover focus.overHover').on('mouseenter.overHover focus.overHover', function(){
